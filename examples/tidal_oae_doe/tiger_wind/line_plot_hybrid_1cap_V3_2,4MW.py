...
turbine = "modRM1"
baseCSVfile = "../tiger/outputs/2,4MW_modRM1.csv"
sensCSVfile = "outputs/hybrid_1cap_modRM1_2,4MW_30-50-70_wind.csv"
turbineName = "50 Unit Hybrid Arrays: 2.4 MW Wind & 2.4 MW RM1"
...
windCSVfile_CookInlet = "../wind_only/outputs/100kt_50x_2,4MW_wind_Cook_Inlet_1M_rca.csv"
...
colors = cmap(np.linspace(0.2, 0.2, num_colors))
...
for k in range(len(keyResults)):
    for j in range(len(sens_vars)):
        ...
        # plt.show()
        plt.savefig(f"{turbine}_{keyResults[k]}_hybrid_30-50-70_wind_1cap_2,4MW.png", dpi = 300, bbox_inches='tight')
        plt.close()
