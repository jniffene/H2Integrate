...
windCSVfile_CookInlet = "../wind_only/outputs/100kt_50x_3,4MW_wind_Cook_Inlet_1M_rca.csv"
...
for k in range(len(keyResults)):
    for j in range(len(sens_vars)):
        ...
        plt.legend(["  0 Wind | 50 Tidal", "15 Wind | 35 Tidal", "25 Wind | 25 Tidal", "35 Wind | 15 Tidal"], loc='upper right')
        plt.minorticks_on()
        ...
        # plt.show()
        plt.savefig(f"{turbine}_{keyResults[k]}_hybrid_30-50-70_wind_1cap_3,4MW.png", dpi = 300, bbox_inches='tight')
        plt.close()
