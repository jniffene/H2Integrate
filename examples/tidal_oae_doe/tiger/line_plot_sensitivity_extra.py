...
if turbine == "tiger_all2nd":
    ...
    sensCSVfile = "outputs/senseA_Nt_100kt_50x_2-6MW_10-30m_Cook_Inlet_1M_rca_tiger_all2nd.csv"
    ...
    sensCSVfile = "outputs/senseA_Nt_100kt_50x_2-6MW_10-30m_Cook_Inlet_1M_rca_tiger_no2nd.csv"
    ...
    sensCSVfile = "outputs/senseA_Nt_100kt_50x_1-3MW_10-30m_Cook_Inlet_1M_rca_modRM1.csv"
...
for k in range(len(keyResults)):
    for j in range(len(sens_vars)):
        ...
        plt.savefig(f"{turbine}_{keyResults[k]}_{sensNickNames[j]}.png", dpi = 300, bbox_inches='tight')
        plt.close()
