...
varsDF.to_csv('sensitivity_input_cases.csv', index=False, header=False)
valsDF = pd.DataFrame(vals)
valsDF.to_csv('sensitivity_input_cases.csv', index=False, header=False, mode ='a')